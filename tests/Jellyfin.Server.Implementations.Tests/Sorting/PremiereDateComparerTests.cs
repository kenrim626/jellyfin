    ...
    public class PremiereDateComparerTests
    {
        ...
        private sealed class PremiereDateTestData : TheoryData<BaseItem, BaseItem, int>
        {
            public PremiereDateTestData()
            {
                ...
                Add(
                    new Video { PremiereDate = new DateTime(2018, 1, 1) },
                    new Video { PremiereDate = new DateTime(2018, 1, 3) },
                    -1);

                // Both have premiere date, but y has invalid date
                // Expected: y listed first
                Add(
                    new Video { PremiereDate = new DateTime(2019, 1, 1) },
                    new Video { PremiereDate = new DateTime(03, 1, 1) },
                    1);

                // Only x has premiere date, with earlier year than y
                // Expected: x listed first
                Add(
                    new Video { PremiereDate = new DateTime(2020, 1, 1) },
                    new Video { ProductionYear = 2021 },
                    -1);

                // Only x has premiere date, with same year as y
                // Expected: y listed first
                Add(
                    new Video { PremiereDate = new DateTime(2022, 1, 2) },
                    new Video { ProductionYear = 2022 },
                    1);

                // Only x has a premiere date, with later year than y
                // Expected: y listed first
                Add(
                    new Video { PremiereDate = new DateTime(2024, 3, 1) },
                    new Video { ProductionYear = 2023 },
                    1);

                // Only x has a premiere date, y has an invalid year
                // Expected: y listed first
                Add(
                    new Video { PremiereDate = new DateTime(2025, 1, 1) },
                    new Video { ProductionYear = 0 },
                    1);

                // Only x has a premiere date, y has neither date nor year
                // Expected: y listed first
                Add(
                    new Video { PremiereDate = new DateTime(2026, 1, 1) },
                    new Video(),
                    1);
            }
        }
